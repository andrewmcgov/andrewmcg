...
tags: ['css', 'flexbox']
description: 'I made a visual flexbox demo that makes it really easy to find the right flexbox property. Made with vanilla HTML, CSS, and JS.'
---

import {BlogPostHeader} from '../components/BlogPostHeader';

<BlogPostHeader title="Visual flexbox demo" date={'2021-04-03'} />
