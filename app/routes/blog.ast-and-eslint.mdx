...
<Banner status="info">
  <span>
    ...
    syntax trees, I found [this
    article](https://medium.com/basecs/leveling-up-ones-parsing-game-with-asts-d7a6fc2400ff)
    very helpful.
  </span>
</Banner>
...
![code that calls a function called sayHello that returns a greeting with the passed name](/ast-sample-code.jpeg)
...
![a diagram showing the above code broken down into a tree](/ast-tree-example.jpeg)
...
![language and parser toggles on astexplorer.net](/ast-toggle-language-and-parser.png)
...
![AST Explorer showing a block statement highlighted in the syntax tree](/ast-blockstatement-highlighted.png)
...
![AST Explorer reprting errors for our lint rule](/ast-rule-output.png)
