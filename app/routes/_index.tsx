      ...
      <section className="bg-cyan-800 rounded-rounded-section md:rounded-md-rounded-section py-20 md:mt-32 ">
        <div className="max-w-3xl px-4 mx-auto leading-relaxed text-lg">
          ...
          <p className="mb-3">
            ...
            studied music in university, and have recently been getting back
            into playing guitar. It's a great way to get into a creative flow
            state.
          </p>
          <p className="mb-3">
            I am a big sports fan, and have had the misfortune of rooting for
            the Toronto Maple Leafs for my whole life. Maybe this is the year? I
